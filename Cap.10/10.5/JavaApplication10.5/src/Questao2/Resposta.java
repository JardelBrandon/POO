...
Ao tentar chamar o método getSaldo através da referência t, ocorre a seguinte excessão descrita abaixo.
Pois a referência t é do tipo tributável, enquanto o método getSaldo é do tipo conta, e nem todo tributável
tem acesso a classe conta, por isso o método não é encontrado.

Exception in thread "main" java.lang.RuntimeException: Uncompilable source code - Erroneous tree type: <any>
	at Questao2.TestaTributavel.main(TestaTributavel.java:61)
